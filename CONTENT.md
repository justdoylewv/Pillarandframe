...
- The annual agreement was priced on 21 September: four Stories for $30,000 against $34,000 bought one at a time, so the $7,500 per project rate is on the page rather than implied. That figure is Doyle's, given as an example and taken as the price; the derivation is printed so it corrects in one edit. **It is quoted against the retired Story tier, so `annual_written` and `annual_video` on the restructured branch still need their own numbers: the core three is a larger package than Story was.**
...
- Delivery guarantee changed from fourteen days to thirty on 19 September 2026 at Doyle's instruction; fourteen was judged too aggressive. On 21 September a pause clause was added: the thirty days stop while Pillar & Frame is waiting on client-side approvals, releases or owner sign-off. Weather already paused the clock; approval delay did not, and on commercial work that is the likelier delay. Confirm the thirty-day guarantee and approval timing before public launch.
