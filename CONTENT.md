...
- The Build Record was added on 21 September: a retainer for a job that is still running, priced per month by build length. A monthly site visit, a monthly update cut for owners, lenders and the board, and the full story at completion. It is a third card beside the core and the year.
