...
- The Build Record was added on 21 September at a flat $3,000 a month, a retainer for a job that is still running. The earlier $1,500 floor was dropped because a monthly visit has to carry a local crew on site before anything is edited. A monthly site visit, a monthly update cut for owners, lenders and the board, and the full story at completion. It is a third card beside the core and the year.
...
- The social set is **five verticals**, fixed. It was singular, then a five to ten range, then fixed on 21 September: a range invites the buyer to assume the low end and sits badly next to a fixed-list, fixed-price argument.
- Audience wording: the page sells to builders, contractors and trades, and the buyer is sometimes the builder or the GC themselves. Copy must not presume the reader is a general contractor being picked by an owner's committee. The problem section says "the people choosing who gets the job" for this reason.  "Additional social cut" was removed as an add-on because the core now carries five to ten.
