...
gets=[('The hero film.','Two to four minutes. The job start to finish, told by the people who did it and the client it was built for. This is the anchor, and everything else is trimmed from it. Built for the pre-qual package, the bid presentation, the trade show booth and your homepage.'),('The written case study.','Eight hundred to twelve hundred words at a link that is yours. It gets forwarded internally, it goes into an ENR or AGC awards submission, and it still ranks in two years.'),('The social set.','Five verticals, fifteen to forty-five seconds each, captioned and ready to post. Some are moments from the job. Some are your people answering the question every buyer asks before they sign. Not one cut you ration out. A quarter of supply.')]
...
core={
 'written':[('The core three',money('core_written'),'one project','The film, the written case study and the social set. Everything one job produces, out of one day on site.',
    ['Hero case study film, 2\u20134 min','Written case study, 800\u20131,200 words','Social cuts, 5 verticals at 15\u201345s'],False),
 ...
 'video':[('The core two',money('core_video'),'one project','The film and the social set, without the written case study. Same day on site, same footage.',
    ['Hero case study film, 2\u20134 min','Social cuts, 5 verticals at 15\u201345s'],False),
...
terms=[('First cut in fourteen days or you do not pay.','Fourteen days after we leave the site, the first cut is in your hands. A day late and the project is free and you keep everything. Only that first cut carries a date, and its clock pauses on your approvals.'),('We work around your job, not the other way round.','Up to a full day on site, on your schedule. We bring our own insurance certificates, PPE and releases, and nobody on your crew gets pulled off the work to stand in front of a camera.'),('If the footage is not right, we come back on our dime.','Our crews are local, so a return visit costs you nothing. No travel, no mobilisation, no change order. If what we got does not hold up, we book another day and eat the cost.')]
