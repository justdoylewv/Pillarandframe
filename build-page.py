...
terms=[('First cut in fourteen days or you do not pay.','The first cut is in your hands fourteen days after we leave the site. A day late and the project is free and you keep everything. Everything after the first cut moves at the speed of your approvals, so we do not put a date on it. The clock pauses while we are waiting on you, which means approvals, releases and sign-off from the owner or your client. It starts again the day we have what we need.'),('We work around your job.','Up to a full day on site, on your schedule. The work does not slow down.'),('If the footage is not right, we come back on our dime.','Our crews are local, so there are never travel costs. Not for the shoot and not if we need to come back.')]
